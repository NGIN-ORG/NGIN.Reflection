...
struct TypeHandle {
  ...
  constexpr bool valid() const noexcept { return index != static_cast<NGIN::UInt32>(-1); }
};

struct FieldHandle {
  NGIN::UInt32 typeIndex {static_cast<NGIN::UInt32>(-1)};
  NGIN::UInt32 fieldIndex {static_cast<NGIN::UInt32>(-1)};
  constexpr bool valid() const noexcept { return typeIndex != static_cast<NGIN::UInt32>(-1) && fieldIndex != static_cast<NGIN::UInt32>(-1); }
};
